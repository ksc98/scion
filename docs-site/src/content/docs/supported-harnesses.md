...
Auth type can be explicitly set via `auth_selectedType` in your Scion settings profile. See [Agent Credentials](./advanced-local/agent-credentials/) for details.
